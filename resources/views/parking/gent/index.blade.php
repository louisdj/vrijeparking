        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2>Parking {{ $parking->description }} ({{ $parking->city->name  }})</h2>
                    {{--<hr class="star-light">--}}
                </div>
            </div>
        </div>
                    ...
                    <script>
                      ...
                      function initialize()
                      {
                           ...
                           var contentString = '<div id="content">'+
                                 '<div id="siteNotice">'+
                                 '</div>'+
                                 '<h3 id="firstHeading" class="firstHeading">{{ $parking->description }} ({{ $parking->city->name  }})</h3>'+
                                 '</div>';
                             ...
                             var marker = new google.maps.Marker({
                               ...
                               map: map,
                               title: '{{ $parking->description }} ({{ $parking->city->name  }})'
                             });
