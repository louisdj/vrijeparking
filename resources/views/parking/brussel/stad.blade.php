    ...
    <section id="portfolio">
        <div class="container">
            <div class="row">
                    ...
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            @foreach($data->Brussels as $parking)
                                    ...
                                    <tr style="cursor:pointer" onclick="window.location.href='/parking/{{ $parking->name_nl }}'" class="@if(($parking->free_places / $parking->total_places) > 0.90) danger
                                                @elseif(($parking->free_places / $parking->total_places) > 0.70) warning @endif">
                                        <td>
                                        ...
                                        <td>
                                                {{ $parking->total_places - $parking->free_places }} / {{ $parking->total_places }}
                                        </td>
                                    </tr>
                ...
                <div class="col-md-4">
                    <div id="container" style="min-width: 310px; height: 100%; max-width: 600px; margin: 0 auto"></div>
                </div>
...
//                    });
                          ...
                          function initialize()
                          {
                           var mapOptions = {
                             zoom: 13,
                             center: new google.maps.LatLng(50.852293,4.357532)
                           }
